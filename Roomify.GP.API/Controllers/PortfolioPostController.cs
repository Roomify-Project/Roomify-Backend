...
namespace Roomify.GP.API.Controllers
{
    ...
    public class PortfolioPostController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetById(Guid id)
        {
            ...
            if (post == null) return NotFound(new ApiErrorResponse(404, "The Post Doesn't Exist"));
        ...
        {
            if (userId == Guid.Empty) return BadRequest(new ApiErrorResponse(400, "Invalid User ID"));
            //assigning the ApplicationUser, to retrieve the user from DB
        ...
        public async Task<IActionResult> Delete(Guid id)
        {
            ...
            {
                // Log or continue, but don’t fail the request — image deletion shouldn't block post deletion
