...
namespace Roomify.GP.API.Controllers
{
    ...
    public class RoomImageController : ControllerBase
    {
        ...
        public RoomImageController(IRoomImageService roomImageService, IAIResultHistoryRepository aIResultHistoryRepository)
        {
        ...
        public async Task<IActionResult> GeneratedHistory([FromForm] IFormFile image, [FromForm] string descriptionText, [FromForm] RoomStyle roomStyle, [FromForm] RoomType roomType, [FromForm] string userId)
        {
            try
            {
        ...
        public async Task<IActionResult> SaveDesign([FromForm] string imageUrl, [FromForm] string userId)
        {
            try
            {
