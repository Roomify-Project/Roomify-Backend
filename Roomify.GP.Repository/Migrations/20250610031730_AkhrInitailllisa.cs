        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PortfolioPosts_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomImages_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_SavedDesigns_SavedDesignId",
                        column: x => x.SavedDesignId,
                        principalTable: "SavedDesigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Likes_PortfolioPosts_PortfolioPostId",
                        column: x => x.PortfolioPostId,
                        principalTable: "PortfolioPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Likes_SavedDesigns_SavedDesignId",
                        column: x => x.SavedDesignId,
                        principalTable: "SavedDesigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_SavedDesignId",
                table: "Comments",
                column: "SavedDesignId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_PortfolioPostId",
                table: "Likes",
                column: "PortfolioPostId");

            migrationBuilder.CreateIndex(
                name: "IX_Likes_SavedDesignId",
                table: "Likes",
                column: "SavedDesignId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PortfolioPosts_ApplicationUserId",
